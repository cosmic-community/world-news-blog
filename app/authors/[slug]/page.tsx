        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {avatar ? (
            <img
              ...
              width={128}
              height={128}
              className="w-32 h-32 rounded-full object-cover mx-auto mb-6 ring-4 ring-white shadow-lg"
            />
          ) : (
            <div className="w-32 h-32 rounded-full bg-gray-200 mx-auto mb-6 flex items-center justify-center text-5xl shadow-lg">
              ✍️
            </div>
          )}
